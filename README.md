## 👋 Hey there! I'm Praneet 👨‍💻

🚀 Newbie Developer | DevOps & Cloud Enthusiast | Cybersecurity Explorer | AI/ML Learner  

🎯 Currently learning and exploring:
- ☁️ Cloud Computing (AWS, GCP, Azure)
- ⚙️ DevOps tools & practices (Docker, Kubernetes, CI/CD, Terraform, Linux)
- 🔐 Cybersecurity fundamentals & ethical hacking
- 🤖 AI & Machine Learning (from beginner to advanced concepts)
- 💾 System Engineering, DBMS, Operating Systems
- 📚 DSA (Data Structures & Algorithms)

🛠️ I’m passionate about:
- 🌐 Building scalable, secure, and reliable systems
- 🖥️ Automating infrastructure and workflows
- 📖 Designing intelligent systems using AI/ML
- 🔒 Strengthening cybersecurity in cloud-native environments
